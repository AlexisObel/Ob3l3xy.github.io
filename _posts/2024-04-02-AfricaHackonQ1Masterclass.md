...
![Alt Text](/assets/img/em.PNG)

The passwords were separated and saved to pass.txt

![Alt Text](/assets/img/ps3.PNG)
...
![Alt Text](/assets/img/payload4.PNG)
...
![Alt Text](/assets/img/pay.PNG)

I loaded the emails.txt then pass.txt from the tmp file:

![Alt Text](/assets/img/load1.PNG)

![Alt Text](/assets/img/load1p2.PNG)

I loaded the passwords too:

![Alt Text](/assets/img/load2.PNG)

![Alt Text](/assets/img/load2p2.PNG)
